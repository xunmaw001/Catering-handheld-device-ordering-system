<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="加盟名称" prop="jiamengmingcheng">
          <el-input v-model="ruleForm.jiamengmingcheng" 
              placeholder="加盟名称" clearable  :readonly="ro.jiamengmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="加盟名称" prop="jiamengmingcheng">
              <el-input v-model="ruleForm.jiamengmingcheng" 
                placeholder="加盟名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="加盟地区" prop="jiamengdiqu">
          <el-input v-model="ruleForm.jiamengdiqu" 
              placeholder="加盟地区" clearable  :readonly="ro.jiamengdiqu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="加盟地区" prop="jiamengdiqu">
              <el-input v-model="ruleForm.jiamengdiqu" 
                placeholder="加盟地区" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='jiamengmingcheng'){
            this.ruleForm.jiamengmingcheng = obj[o];
	    this.ro.jiamengmingcheng = true;
            continue;
          }
          if(o=='jiamengdiqu'){
            this.ruleForm.jiamengdiqu = obj[o];
	    this.ro.jiamengdiqu = true;
            continue;
          }
          if(o=='zhanghao'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiamengshenqing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiamengshenqingCrossAddOrUpdateFlag = false;
                  this.parent.search();
