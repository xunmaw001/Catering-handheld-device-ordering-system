    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="餐饮店详情" prop="canyindianxiangqing">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="餐饮店详情"
                  v-model="ruleForm.canyindianxiangqing" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.canyindianxiangqing" label="餐饮店详情" prop="canyindianxiangqing">
                    <span>{{ruleForm.canyindianxiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	lianxifangshi : false,
      ...
      rules: {
          canyindianzhanghao: [
                { required: true, message: '餐饮店账号不能为空', trigger: 'blur' },
          ],
          mima: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dizhi = true;
          ...
          if(o=='canyindianxiangqing'){
            this.ruleForm.canyindianxiangqing = obj[o];
	    this.ro.canyindianxiangqing = true;
            continue;
          }
          if(o=='lianxifangshi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `canyindian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.canyindianCrossAddOrUpdateFlag = false;
                  this.parent.search();
