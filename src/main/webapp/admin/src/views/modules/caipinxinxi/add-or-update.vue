    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="口味偏好" prop="kouweipianhao">
          <el-input v-model="ruleForm.kouweipianhao" 
              placeholder="口味偏好" clearable  :readonly="ro.kouweipianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="口味偏好" prop="kouweipianhao">
              <el-input v-model="ruleForm.kouweipianhao" 
                placeholder="口味偏好" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.canyindianzhanghao!=''&&json.canyindianzhanghao){
              		this.ruleForm.canyindianzhanghao = json.canyindianzhanghao
		}
		if(json.canyindianmingcheng!=''&&json.canyindianmingcheng){
              		this.ruleForm.canyindianmingcheng = json.canyindianmingcheng
		}
        } else {
	...
	this.ruleForm.jianjie = this.ruleForm.jianjie.replace(reg,'../../../ssmo4419/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
