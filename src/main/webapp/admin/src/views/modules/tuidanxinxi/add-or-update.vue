<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="菜系" prop="caixi">
          <el-input v-model="ruleForm.caixi" 
              placeholder="菜系" clearable  :readonly="ro.caixi"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="餐饮店账号" prop="canyindianzhanghao">
          <el-input v-model="ruleForm.canyindianzhanghao" 
              placeholder="餐饮店账号" clearable  :readonly="ro.canyindianzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="餐饮店账号" prop="canyindianzhanghao">
              <el-input v-model="ruleForm.canyindianzhanghao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="餐桌" prop="canzhuo">
          <el-input v-model="ruleForm.canzhuo" 
              placeholder="餐桌" clearable  :readonly="ro.canzhuo"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="退单时间" prop="tuidanshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.tuidanshijian" 
                type="datetime"
                placeholder="退单时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuidanshijian" label="退单时间" prop="tuidanshijian">
              <el-input v-model="ruleForm.tuidanshijian" 
                placeholder="退单时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="退单原因" prop="tuidanyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="退单原因"
                  v-model="ruleForm.tuidanyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tuidanyuanyin" label="退单原因" prop="tuidanyuanyin">
                    <span>{{ruleForm.tuidanyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='tuidanshijian'){
            this.ruleForm.tuidanshijian = obj[o];
	    this.ro.tuidanshijian = true;
            continue;
          }
          if(o=='tuidanyuanyin'){
            this.ruleForm.tuidanyuanyin = obj[o];
	    this.ro.tuidanyuanyin = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `tuidanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tuidanxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
