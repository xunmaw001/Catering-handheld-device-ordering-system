  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='canyindian'"  label="餐饮店账号" prop="canyindianzhanghao">
          <el-input v-model="ruleForm.canyindianzhanghao" readonly              placeholder="餐饮店账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='canyindian'"  label="餐饮店名称" prop="canyindianmingcheng">
          <el-input v-model="ruleForm.canyindianmingcheng"               placeholder="餐饮店名称" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='canyindian'" label="图片" prop="tupian">
          <file-upload
          tip="点击上传图片"
          action="file/upload"
          :limit="3"
          ...
          @change="canyindiantupianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='canyindian'"  label="地址" prop="dizhi">
          <el-input v-model="ruleForm.dizhi"               placeholder="地址" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='canyindian'"  label="餐饮店详情" prop="canyindianxiangqing">
          <el-input v-model="ruleForm.canyindianxiangqing"               placeholder="餐饮店详情" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='canyindian'"  label="联系方式" prop="lianxifangshi">
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='yuangong'" label="餐饮店账号" prop="canyindianzhanghao">
          <el-select  @change="yuangongcanyindianzhanghaoChange" v-model="ruleForm.canyindianzhanghao" placeholder="请选择餐饮店账号">
            <el-option
                v-for="(item,index) in yuangongcanyindianzhanghaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yuangong'"  label="餐饮店名称" prop="canyindianmingcheng">
          <el-input v-model="ruleForm.canyindianmingcheng"               placeholder="餐饮店名称" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  data() {
    return {
      ...
      yuangongcanyindianzhanghaoOptions: [],
    };
  },
  mounted() {
    ...
    this.$http({
      ...
      if (data && data.code === 0) {
        this.yuangongcanyindianzhanghaoOptions = data.data;
      } else {
        this.$message.error(data.msg);
      }
    });
  ...
  methods: {
    // 下二随
    yuangongcanyindianzhanghaoChange () {
      this.$http({
    ...
    canyindiantupianUploadChange(fileUrls) {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.canyindianzhanghao)&& 'canyindian'==this.flag){
        this.$message.error('餐饮店账号不能为空');
        return
      }
      if((!this.ruleForm.mima)&& 'canyindian'==this.flag){
        this.$message.error('密码不能为空');
        return
      }
      if( 'canyindian' ==this.flag && this.ruleForm.lianxifangshi&&(!isMobile(this.ruleForm.lianxifangshi))){
