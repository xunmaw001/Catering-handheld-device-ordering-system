  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(106, 0, 138, 0.47);borderRadius:10px">
        <h1 class="h1" style="color:rgba(251, 247, 247, 1);fontSize:28px;">餐饮掌上设备点餐系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='canyindian'" class="input-group">
			   <div class="label">餐饮店账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.canyindianzhanghao" class="input" type="text" placeholder="餐饮店账号">
			   </div>
			 </div> -->
			<el-form-item label="餐饮店账号" class="input" v-if="tableName=='canyindian'">
			  <el-input v-model="ruleForm.canyindianzhanghao" autocomplete="off" placeholder="餐饮店账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='canyindian'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='canyindian'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='canyindian'" class="input-group">
			   <div class="label">餐饮店名称</div>
			   <div class="input-container">
			     <input v-model="ruleForm.canyindianmingcheng" class="input" type="text" placeholder="餐饮店名称">
			   </div>
			 </div> -->
			<el-form-item label="餐饮店名称" class="input" v-if="tableName=='canyindian'">
			  <el-input v-model="ruleForm.canyindianmingcheng" autocomplete="off" placeholder="餐饮店名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='canyindian'" class="input-group">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='canyindian'">
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='canyindian'">
			...
			<el-form-item label="餐饮店名称" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.canyindianmingcheng" autocomplete="off" placeholder="餐饮店名称"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.canyindianzhanghao) && `canyindian` == this.tableName){
        this.$message.error(`餐饮店账号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `canyindian` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if(`canyindian` == this.tableName && this.ruleForm.lianxifangshi&&(!this.$validate.isMobile(this.ruleForm.lianxifangshi))){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20201114/8ca3cf2430494a60b13d02f525b3557b.jpg");
		height: 100vh;
